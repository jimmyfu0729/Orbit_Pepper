...
parser.add_argument("--num_robots", type=int, default=20, help="Number of robots to spawn.")
...
from omni.isaac.orbit.robots.config.PEPPER_CFG_base import PEPPER_CFG_base
from omni.isaac.orbit.robots.config.PEPPER_CFG import PEPPER_CFG
from omni.isaac.orbit.robots.config.PEPPER_CFG_simple import PEPPER_CFG_simple
...
def main():
    ...
    elif args_cli.robot == "pepper_base":
         robot_cfg = PEPPER_CFG_base
    elif args_cli.robot=="pepper_simple":
        robot_cfg=PEPPER_CFG_simple
    else:
        raise ValueError(f"Robot {args_cli.robot} is not supported. Valid: pepper, pepper_base, pepper_simple")
    ...
    while simulation_app.is_running():
        ...
        if not sim.is_playing():
            ...
            continue
        # reset
        for dof_names in robot.dof_names:
            print(dof_names)
