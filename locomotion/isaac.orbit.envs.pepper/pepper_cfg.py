...
class RandomizationCfg:
    ...
    class ObjectInitialPoseCfg:
        ...
        # randomize position
        position_uniform_min = [-100, -100, 0.3]  # position (x,y,z)
        position_uniform_max = [100, 100, 0.5]  # position (x,y,z)
...
class ObservationsCfg:
    ...
    class PolicyCfg:
        ...
        #object_relative_base_positions = {"scale": 1.0}
        # object_relative_tool_orientations = {"scale": 1.0}
        # -- object desired state
        #object_desired_positions = {"scale": 1.0}
        # -- previous action
        base_actions = {"scale": 1.0}
...
class RewardsCfg:
    ...
    # -- action-centric
    #penalizing_facing_direction = {"weight": 1e-2}
    #penalizing_collision = {"weight": 0.05}
    # penalizing_tool_action_l2 = {"weight": 1e-2}
    # -- object-centric
    # tracking_object_position_exp = {"weight": 5.0, "sigma": 0.25, "threshold": 0.08}
    tracking_position_success = {"weight": 5.0, "threshold": 0.08}
...
class PepperEnvCfg(IsaacEnvCfg):
    ...
    # General Settings
    env: EnvCfg = EnvCfg(num_envs=4096, env_spacing=12.0, episode_length_s=5.0)
